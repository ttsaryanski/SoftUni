...
const temp = (item, isOwner, hasUser, hasLiked, likes) => html`
    ...
    <section id="details">
        <div id="details-wrapper">
            ...
            <p id="details-date">Date:<span id="date">${item.date}</span></p>
            <div id="info-wrapper">
            ...
            ${hasUser ? html`
                ...
                ${hasLiked ? null : html`
                    ...
                    <div id="action-buttons">
                        <a @click=${onLike} data-id=${item._id} href="" id="go-btn">Going</a>
                    </div>`}
            ` : ''}
        </div>
    </section>
...
async function onLike(e) {
    ...
    await likesService.postLike({eventId});
    goTo(`/details/${eventId}`);
}
