...
class DNACodeLanguage implements Language {
    private readonly _charset: Set<DNAChar> = new Set<DNAChar>([
        "A",
        "C",
        "G",
        "T",
    ...
    get charset(): Set<DNAChar> {
        return this._charset;
    }

    isCompatibleToCharset(message: string): boolean {
        return [...message].every((char) => this._charset.has(char as DNAChar));
    }
}
