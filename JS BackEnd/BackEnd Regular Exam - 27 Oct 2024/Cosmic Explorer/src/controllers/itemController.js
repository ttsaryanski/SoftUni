...
router.get('/catalog', async (req, res) => {
    try {
        ...
        res.render('item/catalog', { items, title: 'Planet Catalog', error: createErrorMsg(null, sessionError) });    
    } catch (error) {
        return res.render('item/catalog', { title: 'Planet Catalog', error: createErrorMsg(error, null) });
    }
});

router.get('/create', isAuth, (req, res) => {
    res.render('item/create', { title: 'Add New Planet'});
});
...
router.post('/create', isAuth, async (req, res) => {
    ...
    try {
        ...
        return res.render('item/create', { item, title: 'Add New Planet', error: createErrorMsg(error, null) });
    }
});
...
router.get('/search', async (req, res) => {
    ...
    try {
        ...
        res.render('item/search', { items, query, title: 'Planet Search' }); 
    } catch (error) {
        return res.render('item/search', { title: 'Planet Search', error: createErrorMsg(error, null)});
    }
});
...
router.get('/:itemId/details', async (req, res) => {
    ...
    try {
        ...
        res.render('item/details', { item, isOwner, isLiked, owner, users, usersList, title: 'Planet Details' }); // Remove the excess!!!
    } catch (error) {
        return res.render('item/details', { title: 'Planet Details', error: createErrorMsg(error, null) });
    }
});
...
router.get('/:itemId/edit', isAuth, checkOwner, async (req, res) => {
    ...
    try {
        ...
        res.render('item/edit', { item, title: 'Edit Planet' });
    } catch (error) {
        return res.render('item/edit', { title: 'Edit Planet', error: createErrorMsg(error, null) });
    }
});
...
router.post('/:itemId/edit', isAuth, checkOwner, async (req, res) => {
    ...
    try {
        ...
        return res.render('item/edit', { item, title: 'Edit Planet', error: createErrorMsg(error, null) });
    }
});
