...
router.get('/catalog', async (req, res) => {
    try {
        ...
        return res.render('item/catalog', { title: 'Catalog Page - Gaming Team', error: createErrorMsg(error) });
    }
});
...
router.post('/create', isAuth, async (req, res) => {
    ...
    try {
        ...
        return res.render('item/create', { item, title: 'Create Page - Gaming Team', error: createErrorMsg(error) });
    }
});
...
router.get('/search', async (req, res) => {
    ...
    try {
        ...
        return res.render('item/search', { title: 'Search - Gaming Team', error: createErrorMsg(error)});
    }
});
...
router.get('/:itemId/delete', isAuth, checkOwner, async (req, res) => {
    ...
    try {
        ...
        return res.render('404', { title: '404 Page - Gaming Team', error: createErrorMsg(error) });
    }
});
...
router.get('/:itemId/edit', isAuth, checkOwner, async (req, res) => {
    ...
    try {
        ...
        return res.render('item/edit', { title: 'Edit Page - Gaming Team', error: createErrorMsg(error) });
    }
});
...
router.post('/:itemId/edit', isAuth, checkOwner, async (req, res) => {
    ...
    try {
        ...
        return res.render('item/edit', { item, title: 'Edit Page - Gaming Team', error: createErrorMsg(error) });
    }
});
