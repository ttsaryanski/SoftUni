...
router.get('/catalog', async (req, res) => {
    try {
        ...
        res.render('item/catalog', { items, title: 'Dashboard Page' });    
    } catch (error) {
        return res.render('item/catalog', { title: 'Dashboard Page', error: createErrorMsg(error) });
    }
});
...
router.get('/search', async (req, res) => {
    ...
    try {
        ...
        res.render('item/search', { items, query, title: 'Search Page' }); 
    } catch (error) {
        return res.render('item/search', { title: 'Search Page', error: createErrorMsg(error)});
    }
});
