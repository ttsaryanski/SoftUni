...
router.get('/catalog', async (req, res) => {
    try {
        ...
        res.render('item/catalog', { items, title: 'Trade Catalog', error: createErrorMsg(null, sessionError) });    
    } catch (error) {
        return res.render('item/catalog', { title: 'Trade Catalog', error: createErrorMsg(error, null) });
    }
});
...
router.get('/:itemId/details', async (req, res) => {
    ...
    try {
        ...
        res.render('item/details', { item, isOwner, isLiked, owner, users, usersList, title: 'Details Page' }); // Remove the excess!!!
    } catch (error) {
